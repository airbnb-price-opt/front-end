...
class YourListingsModal extends React.Component {
    ...
    render() {
        ...
        const { listing, DeleteListing, setListingEdit, listingEdit } = this.props
        ...
        return (
            <Modal open={open} onOpen={this.open} onClose={this.close} trigger={<Button onClick={() => setListingEdit(listing)}>VIEW DETAILS</Button>} closeIcon>
                ...
                <Modal.Actions>
                    <StyledModalUpdateListingsLink as={ Link } to={{pathname:"/update-listing/", state: {listingEdit}}} onClick={this.close} className='fluid'>UPDATE</StyledModalUpdateListingsLink>
